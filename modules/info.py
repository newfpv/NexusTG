...
async def show_my_info(call: types.CallbackQuery, state: FSMContext):
    ...
    if not userbot_app or not userbot_app.is_connected: return await call.answer(_("err_userbot_not_connected_alert"), show_alert=True)
    ...
    try:
        ...
        info_text = _(
            ...
            dc_id_text=dc_id_text
        )
    except Exception as e:
        info_text = _("info_error", e=e)

    # Кнопка возврата ведет обратно в меню Настроек
